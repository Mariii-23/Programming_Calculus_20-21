...
Sendo o tipo de dados \ensuremath{\Conid{ExpAr}\;\Varid{a}} e partindo do \ensuremath{\Varid{inExpAr}} fornecido, sabendo que, este "constrói" algo do tipo, chegou-se à implementação e ao diagrama do \ensuremath{\Varid{outExpr}}, tendo em mente que este "destrói" o tipo.

\begin{eqnarray*}
\xymatrix@C=2cm{
     \ensuremath{\Conid{ExpAr}\;\Varid{a}}
&
     \ensuremath{\Varid{b}\mathbin{+}(\Varid{a}\mathbin{+}(\Conid{BinOp}\mathbin{*}(\Conid{ExpAr}\;\Varid{a}\mathbin{*}\Conid{ExpAr}\;\Varid{a})\mathbin{+}(\Conid{UnOp}\mathbin{*}\Conid{ExpAr}\;\Varid{a})))}
...
\xymatrix@C=2cm{
   \ensuremath{\Conid{ExpAr}\;\Varid{a}}
          \ar[d]_-{\ensuremath{\Varid{eval\char95 exp}\;\Varid{num}}}
           \ar[r]^-{\ensuremath{\Varid{outExpAr}}}
&
   \ensuremath{\Varid{b}\mathbin{+}(\Varid{a}\mathbin{+}(\Conid{BinOp}}\times\ensuremath{(\Conid{ExpAr}\;\Varid{a}}\times\ensuremath{\Conid{ExpAr}\;\Varid{a})\mathbin{+}(\Conid{UnOp}}\times\ensuremath{\Conid{ExpAr}\;\Varid{a})))}
          \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\mathbin{+}((\Varid{id}}\times\ensuremath{(\Varid{g\char95 eval\char95 exp}\;\Varid{num})\mathbin{\uparrow}\mathrm{2})\mathbin{+}(\Varid{id}}\times\ensuremath{\Varid{g\char95 eval\char95 exp}\;\Varid{num}))}}
\\
    \ensuremath{\Varid{a}}
&
   \ensuremath{\Varid{b}\mathbin{+}(\Varid{a}\mathbin{+}(\Conid{BinOp}}\times\ensuremath{(\Varid{a}}\times\ensuremath{\Varid{a})\mathbin{+}(\Conid{UnOp}}\times\ensuremath{\Varid{a})))}
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{gopt}\;\Varid{num}\mathrel{=}\alt{\underline{\Varid{num}}}{\alt{\Varid{id}}{\alt{\uncurry{\Varid{f}}}{\uncurry{\Varid{g}}}}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{construi\char95 bin}\;(\Conid{Product},(\Varid{a},\Varid{b}))\mathrel{=}(\Conid{Bin}\;\Conid{Product}\;(\p1\;\Varid{a})\;(\p1\;\Varid{b}),\Conid{Bin}\;\Conid{Sum}\;(\Conid{Bin}\;\Conid{Product}\;(\p1\;\Varid{a})\;(\p2\;\Varid{b}))\;(\Conid{Bin}\;\Conid{Product}\;(\p2\;\Varid{a})\;(\p1\;\Varid{b}))){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{loop}\;(\Varid{f},(\Varid{s},\Varid{h}))\mathrel{=}(\Varid{f}\mathbin{*}\Varid{s}\div \Varid{h},(\Varid{s}\mathbin{+}\mathrm{4},\Varid{h}\mathbin{+}\mathrm{1})){}\<[E]%
\\
...
\column{11}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\frac{(\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{2})\mathbin{!}}{(\Varid{n}\mathbin{+}\mathrm{2})\mathbin{!}\mathbin{*}(\Varid{n}\mathbin{+}\mathrm{1})\mathbin{!}}{}\<[E]%
\\
\>[3]{}\hsindent{8}{}\<[11]%
\>[11]{}\mathrel{=}\frac{(\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{2})\mathbin{*}(\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{1})\mathbin{*}(\mathrm{2}\;\Varid{n})\mathbin{!}}{(\Varid{n}\mathbin{+}\mathrm{2})\mathbin{*}(\Varid{n}\mathbin{+}\mathrm{1})\mathbin{!}\mathbin{*}(\Varid{n}\mathbin{+}\mathrm{1})\mathbin{*}\Varid{n}\mathbin{!}}{}\<[E]%
\\
\>[3]{}\hsindent{8}{}\<[11]%
\>[11]{}\mathrel{=}\frac{(\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{2})\mathbin{*}(\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{1})\mathbin{*}(\Varid{c}\;\Varid{n})}{(\Varid{n}\mathbin{+}\mathrm{2})\mathbin{*}(\Varid{n}\mathbin{+}\mathrm{1})}{}\<[E]%
\\
\>[3]{}\hsindent{8}{}\<[11]%
\>[11]{}\mathrel{=}\frac{\mathrm{2}\mathbin{*}(\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{1})\mathbin{*}(\Varid{c}\;\Varid{n})}{\Varid{n}\mathbin{+}\mathrm{2}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Considerando:
\begin{hscode}\SaveRestoreHook
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{s}\;\Varid{n}\mathrel{=}\mathrm{2}\mathbin{*}(\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathrel{=}\mathrm{4}\mathbin{*}\Varid{n}\mathbin{+}\mathrm{2}{}\<[E]%
\\
...
%
\ensuremath{\alt{\Varid{c}\comp \underline{\mathrm{0}}}{\Varid{c}\comp \succ }\mathrel{=}\alt{\underline{\mathrm{1}}}{\uncurry{(\mathbin{*})}\comp \conj{\Varid{c}}{\uncurry{(\mathbin{/})}\comp \conj{\Varid{s}}{\Varid{h}}}}}
\more
...
%
\ensuremath{\Varid{c}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\uncurry{(\mathbin{*})}\comp \conj{\Varid{c}}{\uncurry{(\mathbin{/})}\comp \conj{\Varid{s}}{\Varid{h}}}}}
\more
...
\just\equiv{ Absorção + }
%
\ensuremath{\Varid{c}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\uncurry{(\mathbin{*})}\comp \conj{\p1}{\uncurry{(\mathbin{/})}\comp \conj{\p1\comp \p2}{\p2\comp \p2}}}\comp \Varid{id}\mathbin{+}\conj{\Varid{c}}{\conj{\Varid{s}}{\Varid{h}}}}
\more
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{h}\mathrel{=}\alt{\underline{\cdot }\comp \underline{\Varid{nil}}}{\Varid{g}}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{g}\;(\Varid{d},\Varid{f})\;\Varid{l}\mathrel{=}\mathbf{case}\;\Varid{l}\;\mathbf{of}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{hyloAlgForm}\;\Varid{h}\;\Varid{g}\mathrel{=}\Varid{cataList}\;\Varid{h}\comp \Varid{anaList}\;\Varid{g}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{avg\char95 aux}\mathrel{=}\Varid{cataList}\;\Varid{algo}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{algo}\;(i_1\;\anonymous )\mathrel{=}(\mathrm{0},\mathrm{0}){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{algo}\;(i_2\;(\Varid{a},(\Varid{b},\Varid{c})))\mathrel{=}((\Varid{a}\mathbin{+}\Varid{b}\mathbin{*}\Varid{c})\mathbin{/}\succ \;\Varid{c},\succ \;\Varid{c}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
%% apagar 1
...
&
   \ensuremath{\Conid{A}\mathbin{+}((\mathsf{LTree}\;\Conid{A})} \times \ensuremath{(\mathsf{LTree}\;\Conid{A}))}
          \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{gene}}\times \ensuremath{\Varid{gene})}}
\\
    \ensuremath{\Conid{A}}
&
   \ensuremath{\Conid{A}\mathbin{+}((\Conid{A}}\times\ensuremath{\Conid{A})}\times\ensuremath{(\Conid{A}}\times \ensuremath{\Conid{A}))}
...
\>[72]{}\conj{\conj{\uncurry{(\mathbin{*})}\comp \p1}{\uncurry{(\mathbin{*})}\comp \p2}}{\conj{\p2\comp \p1}{\p2\comp \p2}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

\begin{tabbing}\ttfamily
~Veremos~o~q~o~final~faz\\
\ttfamily ~Primeiro~ele~aplica\char58{}\\
\ttfamily ~split~\char40{}split~\char40{}\char40{}uncurry~\char40{}\char42{}\char41{}\char41{}\char46{}p1\char41{}~\char40{}\char40{}uncurry~\char40{}\char42{}\char41{}\char41{}\char46{}p2\char41{}\char41{}~\char40{}split~\char40{}p2\char46{}p1\char41{}~\char40{}p2\char46{}p2\char41{}\char41{}\\
\ttfamily ~\\
\ttfamily ~final~\char40{}\char40{}a\char44{}b\char41{}\char44{}\char40{}c\char44{}d\char41{}\char41{}~\char45{}\char62{}~~\char40{}~\char40{}~a\char42{}b~\char44{}~c\char42{}d~\char41{}~\char44{}~\char40{}~b\char44{}d~\char41{}~\char41{}\\
\ttfamily ~Depois~aplica\char58{}\\
\ttfamily ~\char40{}\char40{}uncurry~\char40{}\char43{}\char41{}\char41{}~\char62{}\char60{}~\char40{}uncurry~\char40{}\char43{}\char41{}\char41{}\char41{}\\
\ttfamily ~\char40{}~\char40{}~a\char42{}b~\char44{}~c\char42{}d~\char41{}~\char44{}~\char40{}~b\char44{}d~\char41{}~\char41{}~\char45{}\char62{}~\char40{}~a\char42{}b\char43{}c\char42{}d~\char44{}b\char43{}d~\char41{}\\
\ttfamily ~Para~finalizar~aplica\char45{}se~\char58{}\\
\ttfamily ~split~\char40{}uncurry~\char40{}\char47{}\char41{}\char41{}~p2\\
\ttfamily ~\char40{}~a\char43{}b~\char44{}b\char43{}d~\char41{}~\char45{}\char62{}~\char40{}~\char40{}a\char42{}b\char43{}c\char42{}d\char41{}~\char47{}~\char40{}b\char43{}d\char41{}~\char44{}~b\char43{}d~\char41{}\\
\ttfamily ~Concluindo~que\char58{}~\\
\ttfamily ~final~\char40{}\char40{}a\char44{}b\char41{}\char44{}\char40{}c\char44{}d\char41{}\char41{}~~\char61{}~\char40{}~\char40{}a\char43{}b\char41{}~\char47{}~\char40{}b\char43{}d\char41{}~\char44{}~b\char43{}d~\char41{}
\end{tabbing}
%%(( a*b , c*d ) ,(b,d) )
%%( a*b + c*d , b+d  )
%%uncurry (/) ( a*b + c*d , b+d  )
