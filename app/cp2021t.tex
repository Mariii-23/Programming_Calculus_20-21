...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{clean}\;\Conid{X}\mathrel{=}i_1\;\Conid{X}{}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{N}\;\Varid{a})\mathrel{=}i_2\comp i_1\mathbin{\$}\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Varid{op}\;(\Conid{N}\;\Varid{a})\;(\Conid{N}\;\Varid{b}))\mathrel{=}i_2\comp i_1\mathbin{\$}((\Varid{f}\;\Varid{op})\;\Varid{a}\;\Varid{b}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
...
\\
\>[B]{}\Varid{clean}\;(\Conid{Un}\;\Varid{op}\;(\Conid{N}\;\Varid{a}))\mathrel{=}i_2\comp i_1\mathbin{\$}((\Varid{g}\;\Varid{op})\;\Varid{a}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
