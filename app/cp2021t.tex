...
&
   \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\mathbin{+}(\Conid{BinOp}}\times\ensuremath{(\Conid{ExpAr}\;\Conid{A}}\times\ensuremath{\Conid{ExpAr}\;\Conid{A})\mathbin{+}(\Conid{UnOp}}\times\ensuremath{\Conid{ExpAr}\;\Conid{A})))}
          \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\mathbin{+}((\Varid{id}}\times\ensuremath{\cata{\Varid{g\char95 eval\char95 exp}\;\Varid{num}}}^2\ensuremath{)\mathbin{+}(\Varid{id}}\times\ensuremath{\cata{\Varid{g\char95 eval\char95 exp}\;\Varid{num}}))}}
...
&
     \ensuremath{()\mathbin{+}(\Conid{A}\mathbin{+}(\Conid{BinOp}} \times\ensuremath{(\Conid{ExpAr}\;\Conid{A}}\times\ensuremath{\Conid{ExpAr}\;\Conid{A})\mathbin{+}(\Conid{UnOp}}\times\ensuremath{\Conid{ExpAr}\;\Conid{A})))}
          \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\mathbin{+}(\Varid{id}}\times\ensuremath{\cata{\Varid{sd\char95 gen}}}\times\ensuremath{\cata{\Varid{sd\char95 gen}})\mathbin{+}(\Varid{id}}\times\ensuremath{\cata{\Varid{sd\char95 gen}})))}}
          \ar@/^0.650pc/[l]^-{\ensuremath{\Varid{inExpAr}}}
\\
    \ensuremath{\Conid{ExpAr}\;\Conid{A}}
&
   \ensuremath{()\mathbin{+}(\Conid{A}\mathbin{+}(\Conid{BinOp}} \times\ensuremath{(\Conid{ExpAr}\;\Conid{A}}\times\ensuremath{\Conid{ExpAr}\;\Conid{A})}^2\ensuremath{\mathbin{+}(\Conid{UnOp}}\times\ensuremath{(\Conid{ExpAr}\;\Conid{A}}\times\ensuremath{\Conid{ExpAr}\;\Conid{A}))))}
...
&
     \ensuremath{()\mathbin{+}(\Conid{A}\mathbin{+}(\Conid{BinOp}} \times\ensuremath{(\Conid{ExpAr}\;\Conid{A}}\times\ensuremath{\Conid{ExpAr}\;\Conid{A})\mathbin{+}(\Conid{UnOp}}\times\ensuremath{\Conid{ExpAr}\;\Conid{A})))}
          \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\mathbin{+}(\Varid{id}}\times\ensuremath{\cata{\Varid{ad\char95 gen}}}\times\ensuremath{\cata{\Varid{ad\char95 gen}})\mathbin{+}(\Varid{id}}\times\ensuremath{\cata{\Varid{ad\char95 gen}}))}}
...
&
   \ensuremath{\Conid{NPoint}\mathbin{+}([\mskip1.5mu \Conid{NPoint}\mskip1.5mu]}\times\ensuremath{[\mskip1.5mu \Conid{NPoint}\mskip1.5mu])}
...
&
   \ensuremath{\Conid{NPoint}\mathbin{+}(\mathsf{LTree}\;\Conid{NPoint}}\times\ensuremath{\mathsf{LTree}\;\Conid{NPoint})}
...
&
   \ensuremath{\Conid{NPoint}\mathbin{+}(\Conid{OverTime}\;\Conid{NPoint}}\times\ensuremath{\Conid{OverTime}\;\Conid{NPoint})}
...
&
   \ensuremath{\Conid{Double}\mathbin{+}((\mathsf{LTree}\;\Conid{Double})} \times \ensuremath{(\mathsf{LTree}\;\Conid{Double}))}
          \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\cata{\Varid{gene}}}\times \ensuremath{\cata{\Varid{gene}}}}
