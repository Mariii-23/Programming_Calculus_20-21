...
&
   \ensuremath{\Varid{b}\mathbin{+}(\Varid{a}\mathbin{+}(\Conid{BinOp}\mathbin{*}(\Conid{ExpAr}\;\Varid{a}\mathbin{*}\Conid{ExpAr}\;\Varid{a})\mathbin{+}(\Conid{UnOp}\mathbin{*}\Conid{ExpAr}\;\Varid{a})))}
          \ar[d]^{\ensuremath{\Varid{recBlockchain}\;(\Varid{g\char95 eval\char95 exp}\;\Varid{num}))}}
\\
    \ensuremath{\Varid{a}}
&
...
\column{12}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{clean}\;\Conid{X}\mathrel{=}{}\<[12]%
\>[12]{}i_1\;(){}\<[E]%
\\
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{auxiliar}\;((\Varid{a},\Varid{b}),[\mskip1.5mu \mskip1.5mu])\mathrel{=}(\Varid{a}\mathbin{/}\Varid{b},\Varid{b}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{auxiliar}\;((\Varid{a},\Varid{b}),(\Varid{h}\mathbin{:}\Varid{t}))\mathrel{=}\Varid{auxiliar}\;(({}\<[44]%
\>[44]{}\Varid{a}\mathbin{+}\Varid{h},\succ \;\Varid{b}),\Varid{t}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{final}\mathrel{=}\conj{\uncurry{(\mathbin{/})}}{\p2}\comp (\uncurry{(\mathbin{+})}\times\uncurry{(\mathbin{+})})\comp {}\<[74]%
\>[74]{}\conj{\conj{\uncurry{(\mathbin{*})}\comp \p1}{\uncurry{(\mathbin{*})}\comp \p2}}{\conj{\p2\comp \p1}{\p2\comp \p2}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
