...
&
   \ensuremath{\Varid{b}\mathbin{+}(\Varid{a}\mathbin{+}(\Conid{BinOp}\mathbin{*}(\Conid{ExpAr}\;\Varid{a}\mathbin{*}\Conid{ExpAr}\;\Varid{a})\mathbin{+}(\Conid{UnOp}\mathbin{*}\Conid{ExpAr}\;\Varid{a})))}
          \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\mathbin{+}((\Varid{id}\mathbin{*}(\Varid{g\char95 eval\char95 exp}\;\Varid{num})\mathbin{\uparrow}\mathrm{2})\mathbin{+}(\Varid{id}\mathbin{*}\Varid{g\char95 eval\char95 exp}\;\Varid{num}))}}
\\
    \ensuremath{\Varid{a}}
&
   \ensuremath{\Varid{b}\mathbin{+}(\Varid{a}\mathbin{+}(\Conid{BinOp}\mathbin{*}(\Varid{a}\mathbin{*}\Varid{a})\mathbin{+}(\Conid{UnOp}\mathbin{*}\Varid{a})))}
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment  h = either (const 0.0) linear1d}{}\<[E]%
\\
\>[3]{}\hsindent{1}{}\<[4]%
\>[4]{}\mbox{\onelinecomment h = either (const nil) (split (linear1d.p1) p2 )}{}\<[E]%
\\
\>[3]{}\hsindent{1}{}\<[4]%
\>[4]{}\mbox{\onelinecomment  f a b t = (1-t) * a+ t*b}{}\<[E]%
\\
\>[3]{}\hsindent{1}{}\<[4]%
\>[4]{}\mbox{\onelinecomment  -- f (a,b) t = a + t*(b-a)}{}\<[E]%
\\
\>[3]{}\hsindent{1}{}\<[4]%
\>[4]{}\mbox{\onelinecomment  f (a,b) t = (a + t*(b-a), (a,a))}{}\<[E]%
\\
\>[3]{}\hsindent{1}{}\<[4]%
\>[4]{}\mbox{\onelinecomment  h = either (const ()) f}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{deCasteljau}\mathbin{::}[\mskip1.5mu \Conid{NPoint}\mskip1.5mu]\to \Conid{OverTime}\;\Conid{NPoint}{}\<[E]%
\\
...
&
   \ensuremath{\Conid{A}\mathbin{+}((\mathsf{LTree}\;\Conid{A})\mathbin{*}(\mathsf{LTree}\;\Conid{A}))}
          \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{avgLTree}\mathbin{*}\Varid{avgLTree})}}
\\
    \ensuremath{\Conid{A}}
&
