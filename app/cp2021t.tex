...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment  outExpAr :: ExpAr a -> Either}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment      b (Either a (Either (BinOp, (ExpAr a, ExpAr a)) (UnOp, ExpAr a)))}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  outExpAr = undefined}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  arg -> X   | X -> X}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  10 -> N 10 | (N 10)-> 10}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  (Sum,(a,b)) -> Bin Sum a b}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  (Bin Sum a b) -> (Sum,(a,b))}{}\<[E]%
\\
...
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  X -> X}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  N a -> N a}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  Bin _ a b -> a && b}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  Un _ a -> a}{}\<[E]%
\\
\>[B]{}\Varid{recExpAr}\;\Varid{x}\mathrel{=}\Varid{baseExpAr}\;\Varid{id}\;\Varid{id}\;\Varid{id}\;\Varid{x}\;\Varid{x}\;\Varid{id}\;\Varid{x}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  g_eval}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  a () -> a}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  a 10 -> 10}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  a (BinOP,(valor1,valor2)) -> valor1 op valor2}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  a (Un valor )-> un valor}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  INICIAL}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  g_eval_exp a (Left ()) = a}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  g_eval_exp _ (Right (Left a)) = a}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  g_eval_exp _ (Right (Right (Left l) )) = f l}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment    where}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment      f (Sum,(a,b)) = (+) a b}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment      f (Product,(a,b)) = (*) a b}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  g_eval_exp _ (Right (Right (Right l))) = g l}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment    where}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment      g (E,a) = expd a}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment      g (Negate,a) = - a}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Melhor}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  g_eval_exp num = either (const num) (either id (either f g))}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment    where}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment      f (Sum,(a,b)) = (+) a b}{}\<[E]%
...
\>[B]{}\mbox{\onelinecomment      g (Negate,a) = - a}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  versao simplificada}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  funcao, derivada}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  a :: ( a, a')}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  sd_gen (Left ()) = (X , (N 1)) }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  sd_gen (Right (Left a)) = ((N a) , (N 0))}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  sd_gen (Right (Right (Left (op,(a,b)) ))) = ( g , f )}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment    where}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment      g = Bin op (p1 a) (p1 b)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment      f = if( op == Sum ) then Bin Sum (p2 a) (p2 b)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment          else Bin Sum (Bin Product (p1 a) (p2 b)) ( Bin Product ( p2 a ) ( p1 b ))}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  sd_gen (Right (Right (Right (op,a) ))) = ( g , f )}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment    where}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment      g = Un op (p1 a) }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment      f = if (op == Negate) then Un op (p2 a)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment          else Bin Product (Un E (p1 a)) (p2 a)}{}\<[E]%
\\[\blanklineskip]%
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment  ad_gen a (Left ()) = ( a, 1)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  ad_gen _ (Right (Left b)) = (b, 0)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  -- a :: (valor do a real, derivada do a)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  ad_gen _ (Right (Right (Left (op,(a,b))))) = (g, f)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment    where}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment      g = if (op == Sum ) then (+) (p1 a) (p1 b)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment        else (*) (p1 a) (p1 b)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment      f = if( op == Sum ) then (+) (p2 a) (p2 b)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment          -- a * b' + a' * b}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment          else (+) ((*) (p1 a) (p2 b)) ((*) (p2 a) (p1 b))}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  ad_gen _ (Right (Right (Right (op,a)))) = (g, f)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment    where}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment      g = if (op == Negate) then -(p1 a) else Prelude.exp(p1 a)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment      -- exponencial u' * e^u}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment      f = if (op == Negate) then -(p2 a) else (p2 a) * Prelude.exp(p1 a)}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mbox{\onelinecomment g n = (n, 0)}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
