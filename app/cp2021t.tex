...
\ColumnHook
\end{hscode}\resethooks
%% TODO: Mudar para recursividade mutua
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{4}{@{}>{\hspre}l<{\hspost}@{}}%
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{avg\char95 aux}\mathrel{=}\Varid{auxiliar}\comp \conj{\underline{(\mathrm{0},\mathrm{0})}}{\Varid{id}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{1}{}\<[4]%
\>[4]{}\Varid{auxiliar}\;((\Varid{a},\Varid{b}),[\mskip1.5mu \mskip1.5mu])\mathrel{=}(\Varid{a},\Varid{b}){}\<[E]%
\\
\>[3]{}\hsindent{1}{}\<[4]%
\>[4]{}\Varid{auxiliar}\;((\Varid{a},\Varid{b}),(\Varid{h}\mathbin{:}\Varid{t}))\mathrel{=}\Varid{auxiliar}\;(({}\<[44]%
\>[44]{}(\Varid{a}\mathbin{*}\Varid{b}\mathbin{+}\Varid{h})\mathbin{/}\succ \;\Varid{b},\succ \;\Varid{b}),\Varid{t}){}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  avg_aux = cataList gene}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment    where}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment      gene = either (const (0,0)) final}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mbox{\onelinecomment  final ((a,b), (h,t) ) = ((a * b + h ) / succ b , succ b)}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mbox{\onelinecomment  final = split (uncurry (/)) p2 . ((uncurry (+)) >< (uncurry (+))) .  split (split ((uncurry (*)).p1) ((uncurry (*)).p2)) (split (p2.p1) (p2.p2))}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
