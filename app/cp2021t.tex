...
\xymatrix@C=1cm{
   \ensuremath{\Conid{ExpAr}\;\Conid{A}}
          \ar[d]_-{[(\ensuremath{\Varid{clean}})]}
           \ar[r]^-{\ensuremath{\Varid{outExpAr}}}
&
   \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\mathbin{+}(\Conid{BinOp}}\times\ensuremath{(\Conid{ExpAr}\;\Conid{A}}\times\ensuremath{\Conid{ExpAr}\;\Conid{A})\mathbin{+}(\Conid{UnOp}}\times\ensuremath{\Conid{ExpAr}\;\Conid{A})))}
          \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\mathbin{+}((\Varid{id}}\times\ensuremath{(\Varid{clean})}^2\ensuremath{)\mathbin{+}(\Varid{id}}\times\ensuremath{\Varid{clean}))}}
\\
    \ensuremath{\Conid{ExpAr}\;\Conid{A}}
...
&
   \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\mathbin{+}(\Conid{BinOp}}\times\ensuremath{(\Conid{ExpAr}\;\Conid{A}}\times\ensuremath{\Conid{ExpAr}\;\Conid{A})\mathbin{+}(\Conid{UnOp}}\times\ensuremath{\Conid{ExpAr}\;\Conid{A})))}
          \ar[l]^-{\ensuremath{\Varid{outExpAr}}}
          \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\mathbin{+}((\Varid{id}}\times\ensuremath{(\Varid{gopt}\;\Varid{num})}^2\ensuremath{)\mathbin{+}(\Varid{id}}\times\ensuremath{\Varid{gopt}\;\Varid{num}))}}
\\
    \ensuremath{\Conid{A}}
&
   \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\mathbin{+}(\Conid{BinOp}}\times\ensuremath{(\Conid{A}}\times\ensuremath{\Conid{A})\mathbin{+}(\Conid{UnOp}}\times\ensuremath{\Conid{A})))}
...
\\
    \ensuremath{\Conid{ExpAr}\;\Conid{A}}
&
   \ensuremath{(()\mathbin{+}(\Conid{A}\mathbin{+}(\Conid{BinOp}} \times\ensuremath{(\Conid{ExpAr}\;\Conid{A}}\times\ensuremath{\Conid{ExpAr}\;\Conid{A})\mathbin{+}(\Conid{UnOp}}\times\ensuremath{\Conid{ExpAr}\;\Conid{A}))))}^2\ensuremath{}
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mbox{\onelinecomment  coalg [] = i1 ()}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mbox{\onelinecomment  coalg l = i2 $ split (init) (tail) l}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mbox{\onelinecomment  coalg l = i2 $ split (\a -> deCasteljau.init) (\a->deCasteljau.tail) l}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{coalg}\mathrel{=}\bot {}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mbox{\onelinecomment coalg l = i2 $ split (deCasteljau.g) (deCasteljau.tail) l}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mbox{\onelinecomment g (a:t) = a}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{alg}\mathrel{=}\bot {}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mbox{\onelinecomment coalg = split (deCasteljau.cons.(split p1 (init.p2))) (deCasteljau.p2)}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mbox{\onelinecomment  coalg .. (p,q)}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mbox{\onelinecomment  alg = either (const nil) (f)}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mbox{\onelinecomment  f (a,b) = calcLine a b}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mbox{\onelinecomment f (a,b) = \z->(calcLine (a z) (b z) z) }{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\mbox{\onelinecomment  coalg = split id calcLine}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\mbox{\onelinecomment  alg = either (const (nil,([[0.0]],id))) funcao}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\mbox{\onelinecomment  funcao (lista,((a,b),(c,d))) = ((fmap d a) :lista, (a,b) )}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\mbox{\onelinecomment alg ( (a,f1),(b, l)) = either (const ((0,id),(0,[]))) ( (a,f1) , (b, (f1 b):l) ) }{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\mbox{\onelinecomment alg (a, ((a,f1), (b,f2))) = either (const ([],((0,id), (0,id))) ( (f1 b):a ,  ) }{}\<[E]%
\\[\blanklineskip]%
...
&
   \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}}\times \ensuremath{\Conid{A}}^*)
          \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}}\times \ensuremath{\Varid{avg\char95 aux})}}
\\
    \ensuremath{\Conid{A}}
&
   \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}} \times \ensuremath{(\Conid{A}}\times\ensuremath{\Conid{A}))}
